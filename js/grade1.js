document.addEventListener("DOMContentLoaded", () => {
  ...
  const gradeOneStudents = students.filter(student => {
    return student.hasOwnProperty("grade") && student.grade == 1;
  });
  ...
  const formOne_students=document.querySelector("#totalForm1")
 formOne_students.textContent=studentCount;
 const formOneDetails=document.querySelector("#formOneDetails")
 if (studentCount>1) {
