document.addEventListener("DOMContentLoaded", () => {
    ...
    const gradeOneStudents = students.filter(student => {
      return student.hasOwnProperty("grade") && student.grade == 4;
    });
  ...
  const formOne_students=document.querySelector("#totalForm4")
 formOne_students.textContent=studentCount;
 const formOneDetails=document.querySelector("#formfourDetails")
 if (studentCount>1) {
