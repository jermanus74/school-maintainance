document.addEventListener("DOMContentLoaded", () => {
    ...
    const gradeOneStudents = students.filter(student => {
      return student.hasOwnProperty("grade") && student.grade == 2;
    });
  ...
  const formOne_students=document.querySelector("#totalForm2")
 formOne_students.textContent=studentCount;
 const formOneDetails=document.querySelector("#formTwoDetails")
 if (studentCount>1) {
